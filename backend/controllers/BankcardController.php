...
/**
 * BankcardController implements the CRUD actions for WalletWithdrawals model.
 */
class BankcardController extends Controller
{
    ...
    /**
     * Batch Delete existing WalletBankcard model.
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * @return mixed
     * @throws NotFoundHttpException
     * @throws \Exception
    ...
    {
        if (($model = WalletBankcard::findOne($id)) !== null) {
            return $model;
        } else {
